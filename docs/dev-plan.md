...
- [x] **7.1.1** 人物列表视图 — 通过 character_state 表管理
- [x] **7.1.2** 人物详情页 — Guardian 校验时自动记录人物状态

### 7.2 关系图 / 势力图 ✅ 已完成

- [x] **7.2.1** 通过 Agent 对话模式查询人物关系
...
- [x] **9.1.4** `OllamaClient.is_available()` 同步检查修复（改用 urllib）

### 9.2 代码规范 ✅ 已完成

- [x] **9.2.1** Python 端 type hints 全覆盖
- [x] **9.2.2** 前端 TypeScript 编译零错误
